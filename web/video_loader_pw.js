        ...
        if (nodeData.name === "VideoLoaderPW") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                node.updatePreview = function (filename) {
                    ...
                    const timestamp = Date.now(); // 强制绕过浏览器缓存
                ...
                const reloadBtnWidget = this.addWidget("button", "Load/Reload Video", null, () => {
                    let targetPath = "";
                    ...
                    if (targetPath) {
                        ...
                        console.warn("[VideoLoaderPW] No video path found to reload.");
                    }
                });
