...
from .video_spliter_pw import NODE_CLASS_MAPPINGS as VIDEO_SPLITER_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as VIDEO_SPLITER_DISPLAY
...
NODE_CLASS_MAPPINGS.update(VIDEO_SPLITER_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(VIDEO_SPLITER_DISPLAY)
